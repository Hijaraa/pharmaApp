...
@Component
@Order(2) // Run after DatabaseVerificationRunner which has order value of 1
public class DataInitializer implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        try {
            ...
            boolean isH2 = Arrays.asList(environment.getActiveProfiles()).contains("h2");
            System.out.println("Initializing data for " + (isH2 ? "H2" : "MySQL") + " database...");
            ...
            System.err.println("ERROR: Database access error during data initialization: " + e.getMessage());
            System.err.println("This might be due to missing tables or columns identified during verification.");
            e.printStackTrace();
        } catch (Exception e) {
            System.err.println("ERROR: Unexpected error during data initialization: " + e.getMessage());
            e.printStackTrace();
        } finally {
            System.out.println("Data initialization process finished.");
        }
    }
}
